...
print('自己模型线性核预测的值:',_model.w*test_var+_model.b)
...
p_x=[[x/100] for x in range(0,80,1)]
p_x=np.array(p_x)
bbb=_model.hypothesis(test_var)

print('自己模型多项式核预测的值:',bbb)
...
p_x=[[x/100] for x in range(0,80,1)]
p_x=np.array(p_x)
aaa=_model.hypothesis(test_var)

print('自己模型rbf核预测的值:',aaa)
